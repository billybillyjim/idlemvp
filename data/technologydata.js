export default [
    ...
    },
    {
        ...
        Progress: 0,
        Visible: false,
        Requirements: { Technologies: ["Lunar Calendar", "Selective Breeding"] },
        Complexity: 3000,
        isLocked: true,
        demandModifiers: {
            Global: {},
    ...
    },
    {
        ...
        Description: "We can make smooth-sided wooden reinforcers if we can just figure something out.",
        Cost: { "Wood": 100000 },
        Requirements: { Technologies: ["Iron Metal", "Basic Woodworking", "Simple Lathe"] },
        Progress: 0,
        Visible: false,
        Complexity: 1200,
        isLocked: true,
    ...
    {
        Name: "Windmill",
        Description: "Canvas sails are strong, we could even use them to harness the power of the wind on land.",
        Cost: {},
    ...
    {
        Name: "Oil Press",
        Description: "There's delicious oil in these fruits, if we can figure out how to squeeze hard enough.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The oil press has been discovered."); this.isLocked = false; },
    },
    {
        Name: "Smoked Meats",
        Description: "Maybe there is a way to cook the food that is even tastier...",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Smoking meats have been discovered."); this.isLocked = false; },
    },
    {
        Name: "Wineries",
        Description: "Maybe there is a better way to grow grapes and make them into wine.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Wineries have been discovered."); this.isLocked = false; },
    },
    {
        Name: "Granaries",
        Description: "We need to come up with some kind of way to store all this grain where it doesn't get rained on.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Granaries have been discovered."); this.isLocked = false; },
    },
    {
        Name: "Simple Lathe",
        Description: "The ideas behind the spinning wheel could be used in woodworking somehow, probably.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The lathe has been discovered."); this.isLocked = false; },
    },
    {
        Name: "Wooden Bridges",
        Description: "All these dirt roads are very convenient, but leading our people straight into the river can't be the best way.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The wooden bridge has been discovered."); this.isLocked = false; },
    },
    {
        Name: "Sewing Needles",
        Description: "Bronze is a really strong metal, it could even pierce cloth if we did it right.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The sewing needle has been discovered."); this.isLocked = false; },
    },
    {
        Name: "Canvas Sails",
        Description: "It's always so windy out on the water. There may be some way to take advantage of that.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The sail has been discovered."); this.isLocked = false; },
    },
    {
        Name: "Simple Sailboat",
        Description: "Sails have given us ideas to make boats that use them more effectively.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The sailboat has been discovered."); this.isLocked = false; },
    },
    {
        Name: "Simple Maps",
        Description: "We propose a method for displaying what we see somewhere else.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The map has been discovered."); this.isLocked = false; },
    },
    {
        Name: "Postal System",
        Description: "Bratharos is never home. I cannot get a hold of him. We need a system to make it impossible for him to stop avoiding me.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The postal system has been invented."); this.isLocked = false; },
    },
    {
        Name: "Pumice",
        Description: "Yo check out this rock!",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The pumice stone has been discovered."); this.isLocked = false; },
    },
    {
        Name: "Pozzolana",
        Description: "We found some weird glassy rocks near the volcano.",
        Cost: {},
        Requirements: { Technologies: ["Limestone"] },
        Progress: 0,
        Visible: false,
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Pozzolana has been discovered."); this.isLocked = false; },
    },
    {
        Name: "Quicklime",
        Description: "If we cook this specific kind of rock, it gets weird.",
        Cost: {},
        Requirements: { Technologies: ["Limestone", "Firemaking"] },
        Progress: 0,
        Visible: false,
        Complexity: 25000,
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Quicklime has been discovered."); this.isLocked = false; },
    },
    {
        Name: "Limestone",
        Description: "We've found an interesting kind of rock in the quarry. Maybe we can use it for something.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Limestone has been discovered."); this.isLocked = false; },
    },
    {
        Name: "Concrete",
        Description: "Our discoveries around all these different rocks could make for something really useful.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Concrete has been discovered."); this.isLocked = false; },
    },
    {
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Irrigation systems have been invented."); this.isLocked = false; },
    },
    {
        Name: "Aqueduct",
        Description: "There's some really great water up in the mountains. We just need a way to get it to our cities.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The aqueduct has been invented."); this.isLocked = false; },
    },
    {
        Name: "Quarrying",
        Description: "Digging for certain metals is certainly valuable, but we also can make use of rocks, probably.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Quarrying has been invented."); this.isLocked = false; },
    },
    {
        Name: "Sledge Transports",
        Description: "Everybody is tired of carrying everything everywhere. There's gotta be a better way...",
        Cost: {},
        Requirements: { Technologies: ["Basic Woodworking"] },
        Progress: 0,
        Visible: false,
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The sledge has been invented."); this.isLocked = false; },
    },
    {
        Name: "Basic Stoneworking",
        Description: "Eldronar is pretty skilled with a chisel. Give him some time and I bet he makes something sick.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Basic stonework has been invented."); this.isLocked = false; },
    },
    {
        Name: "Boundary Slabs",
        Description: "Now that we have roads places, we would benefit from something to tell people where things were.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The boundary slab has been invented."); this.isLocked = false; },
    },
    {
        Name: "Cobblestone Roads",
        Description: "Someone had the idea, what if we used slabs for the road, too?",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The cobblestone road has been invented."); this.isLocked = false; },
    },
    {
        Name: "The Arch",
        Description: "We have no idea how it could work, but there seems to be some way to place stones so that they hold stuff up.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The arch has been discovered."); this.isLocked = false; },
    },
    {
        Name: "Urban Planning",
        Description: "So far everything we have built in our cities has happened effectively by accident. Is there any other way?",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Urban planning has been invented."); this.isLocked = false; },
    },
    {
        Name: "Lead Metalworking",
        Description: "We found a soft, delicious metal that we might be able to work into useful things.",
        Cost: {},
        Requirements: { Technologies: ["Mining"] },
        Progress: 0,
        Visible: false,
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Lead metalworking has been invented."); this.isLocked = false; },
    },
    {
        Name: "Lead Pipes",
        Description: "We can use this soft metal to move water through tubes. Maybe.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The lead pipe has been invented."); this.isLocked = false; },
    },
    {
        Name: "Sewer System",
        Description: "Our finest minds have come together and are suggesting we don't just dump it all in the street like we have been. There might be something to this...",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The sewer system has been invented."); this.isLocked = false; },
    },
    {
        Name: "Stone Bridges",
        Description: "What if we built an arch over a river?",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The stone bridge has been invented."); this.isLocked = false; },
    },
    {
        Name: "Domes",
        Description: "Okay this is crazy. Perdrik claims he knows how to make an arch that goes in a circle.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The dome has been discovered."); this.isLocked = false; },
    },
    {
        Name: "Hypocausts",
        Description: "The floors of our houses are always so cold. What if we heated them?",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The hypocaust has been invented."); this.isLocked = false; },
    },
    {
        Name: "Newspapers",
        Description: "Our people (particularly our merchants) want to know what is happening in the world so that they can make better decisions.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The newspaper has been invented."); this.isLocked = false; },
    },
    {
        Name: "Intercalary Months",
        Description: "We've noticed that our lunar calendar drifts, the climate no longer matches the seasons. Maybe we need to add some months sometimes.",
        Cost: {},
        Requirements: { Technologies: ["Lunar Calendar"] },
        Progress: 0,
        Visible: false,
        Complexity: 25000,
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The intercalary month has been invented."); this.isLocked = false; },
    },
    {
        Name: "Leap Year",
        Description: "We've noticed that our solar calendar drifts, the solution is obvious. Right?",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The leap year has been invented."); this.isLocked = false; },
    },
    {
        Name: "Papyrus",
        Description: "Now that we can write things, it would be nice if we had a plentiful, wood-based material to write on.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Papyrus has been invented."); this.isLocked = false; },
    },
    {
        Name: "Scrolls",
        Description: "These papyrus sheets are great, but what if we made them longer?",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The scroll has been invented."); this.isLocked = false; },
    },
    {
        Name: "Wax Tablets",
        Description: "While it's nice to have these permanent writing materials, sometimes it would be nice to erase things without grabbing a new sheet or roll.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The wax tablet has been invented."); this.isLocked = false; },
    },
    {
        Name: "Codex",
        Description: "Scrolls are inconvenient and wax tablets aren't permanent. Can we combine the two?",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The codex has been invented."); this.isLocked = false; },
    },
    {
        Name: "Basic Societal Structure",
        Description: "The days when everyone knew everyone are starting to go away. We aren't all equals anymore.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Basic societal structure has been invented."); this.isLocked = false; },
    },
    {
        Name: "Basic Laws",
        Description: "We need to agree and write down that Elbera can't keep doing that.",
        Cost: {},
        Requirements: { Technologies: ["Writing", "Basic Societal Structure", "Basic Government"] },
        Progress: 0,
        Visible: false,
        Complexity: 25000,
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The law has been invented."); this.isLocked = false; },
    },
    {
        Name: "Naval Navigation",
        Description: "If you pay close attention to the night sky, you can actually know what way you are looking! We could use that somehow.",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Naval navigation has been invented."); this.isLocked = false; },
    },
    {
        Name: "Cartography",
        Description: "We've made little maps. What about big maps?",
        Cost: {},
        ...
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("Cartography has been invented."); this.isLocked = false; },
    },
        {
        Name: "Basic Government",
        Description: "We need something to set up rules for others, now that we aren't equal anymore.",
        Cost: {},
        Requirements: { Technologies: ["Basic Societal Structure"] },
        Progress: 0,
        Visible: false,
        Complexity: 25000,
        isLocked: true,
        demandModifiers: { Global: {}, PerCapita: {} },
        Unlock(vm) { vm.logit("The government has been invented."); this.isLocked = false; },
    },
    {
        Name: "Test 1",
        Description: "",
